...
class LocationLocalStorageImpl(private val context: Context) : LocationLocalStorage {
    ...
    override fun saveSelectCity(locationItemData: LocationItemData) {
        val edit = shp.edit()
        edit.putString(SELECTED_CITY_KEY, locationItemData.Key)
        edit.putString(SELECTED_CITY_NAME, locationItemData.EnglishName)
        edit.apply()
